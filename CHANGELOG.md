...
- An **`npx` installer** (`npx ai-product-starter init`, or `npm i -g
  ai-product-starter`) that copies the skill into a project and wires the entry
  files for any tool — AGENTS.md, Claude, Gemini, Copilot, Cursor.
